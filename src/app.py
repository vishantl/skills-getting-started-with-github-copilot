...
activities.update({
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["jake@mergington.edu", "liam@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and meets for all levels",
    ...
    "Science Olympiad": {
        "description": "STEM challenges and competition preparation",
